      ...
      <div className="home-container">
        ...
        <div className="home-section1">
          <div className="home-container03">
            <div className="home-container04">
              <h6 className="home-text04">HOLD</h6>
              <h3 className="home-text05 healine">
            ...
            <div className="home-cards-container">
              <div className="home-card1">
                ...
                <h6 className="home-text08 textXL">1, 2, 3 klasse</h6>
                <span className="home-text09">
                  <span className="home-text10">mon bælte system</span>
                  <br></br>
                  <span>karate blandet med lege</span>
                  <br></br>
                  <br></br>
                </span>
              </div>
              <div className="home-card2">
                ...
                <h6 className="home-text15 textXL">4 klasse+ og voksende</h6>
                <span className="home-text16">
                  <span className="home-text17">
                    Fælles og opdelt træning. 
                  </span>
                  <br></br>
                  <span>Kumite, Kihon, Kata, Selvforsvar, Sports karate.</span>
                  <br></br>
                </span>
              </div>
              <div className="home-card3">
                ...
                <h6 className="home-text21 textXL">Voksen + barn</h6>
                <span className="home-text22">
                  <span>Træn med dit barn</span>
                  <br></br>
                  <br></br>
                  <br></br>
                  <span>Billed af Laust og Jan</span>
                  <br></br>
                </span>
              </div>
            </div>
            <div className="home-work-with-us">
              <div className="home-container08">
                ...
                <h3 className="home-text29 healine">Træning</h3>
                <span className="home-text30">
                  <span className="home-text31">1.-3. klasse</span>
                  <br className="home-text32"></br>
                  <span>Onsdag: 17:00 → 18:00</span>
                  <br className="home-text34"></br>
                  <br className="home-text35"></br>
                  <span className="home-text36">4. klasse +</span>
              ...
              <div className="home-container10">
                ...
                <div className="home-container12">
                  <h4 className="home-text42 healine">
                    <span className="home-text43">Åby Skole</span>
                    <br></br>
                  </h4>
        ...
        <div className="home-section2">
          <div className="home-container13">
            ...
            <h2 className="home-text51 text2XL">
          ...
          <div className="home-growing-company-section">
            ...
            <div className="home-container14">
              ...
              <h3 className="home-text54 healine">A growing company</h3>
              ...
              <div className="home-container18">
                ...
                <span className="home-text57">Amazing page examples</span>
              </div>
              <div className="home-container20">
                ...
                <span className="home-text58">Dynamic components</span>
              </div>
            </div>
          </div>
          <div className="home-container22">
            <h6 className="home-text59">
              <span>THE ENTOURAGE</span>
            </h6>
            <h3 className="home-text61 healine">
        ...
        <div className="home-section3">
          <div className="home-container44">
            <h6 className="home-text64 textSM">
              <span>ON THE COASTLINE</span>
            </h6>
            <h3 className="home-text66 healine">We are missing the summer</h3>
            <span className="home-text67 textXL">
            ...
            <div className="home-services">
              ...
              <div className="home-container45">
                ...
                <h1 className="home-text69 textXL">Grow your market</h1>
              ...
              <div className="home-container47">
                ...
                <h1 className="home-text71 textXL">Launch time</h1>
            ...
            <div className="home-contact">
              ...
              <h2 className="home-text73">Type in the bellow form</h2>
              <span className="home-text74 textXL">
              ...
              <div className="home-form">
                <h1 className="home-text75">Want to work with us?</h1>
                <span className="home-text76 textXL">
                  Complete this form and we will get back to you in 24 hours.
                </span>
                <span className="home-text77 textXS">FULL NAME</span>
                <input
                  type="text"
                  placeholder="Full Name"
                  className="home-textinput textSM input"
                />
                <span className="home-text78 textXS">EMAIL</span>
                <input
                  type="text"
                  placeholder="Email"
                  className="home-textinput1 textSM input"
                />
                <span className="home-text79 textXS">MESSAGE</span>
                <textarea
                  cols="80"
                  rows="4"
                  disabled="true"
