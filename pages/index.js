      ...
      <div className="home-container">
          ...
          <div className="home-container03">
            <div className="home-container04">
              ...
              <span className="home-text06 textXL">
                Vi har opdelt vores træning efter klassetrin
              </span>
            </div>
            <div className="home-cards-container">
              ...
              <div className="home-card3">
                ...
                <h6 className="home-text20 textXL">Forælder + barn</h6>
            ...
            <div className="home-work-with-us">
              <div className="home-container08">
                ...
                <h3 className="home-text28 healine">Træning</h3>
                <span className="home-text29">
                  <span className="home-text30">1.-3. klasse</span>
                  <br className="home-text31"></br>
                  <span>Onsdag: 17:00 → 18:00</span>
                  <br className="home-text33"></br>
                  <br className="home-text34"></br>
                  <span className="home-text35">4. klasse +</span>
              ...
              <div className="home-container10">
                ...
                <div className="home-container12">
                  <h4 className="home-text41 healine">
                    <span className="home-text42">Åby Skole</span>
                    <br></br>
                  </h4>
        ...
        <div className="home-section2">
          <div className="home-container13">
            ...
            <h2 className="home-text50 text2XL">
          ...
          <div className="home-growing-company-section">
            ...
            <div className="home-container14">
              ...
              <h3 className="home-text53 healine">A growing company</h3>
              ...
              <div className="home-container18">
                ...
                <span className="home-text56">Amazing page examples</span>
              </div>
              <div className="home-container20">
                ...
                <span className="home-text57">Dynamic components</span>
              </div>
            </div>
          </div>
          <div className="home-container22">
            <h6 className="home-text58">
              <span>THE ENTOURAGE</span>
            </h6>
            <h3 className="home-text60 healine">
              It is everything, and it won&apos;t change
            </h3>
            <span className="home-text61 textXL">
        ...
        <div className="home-section3">
          <div className="home-container44">
            <h6 className="home-text63 textSM">
              <span>ON THE COASTLINE</span>
            </h6>
            <h3 className="home-text65 healine">We are missing the summer</h3>
            <span className="home-text66 textXL">
            ...
            <div className="home-services">
              ...
              <div className="home-container45">
                ...
                <h1 className="home-text68 textXL">Grow your market</h1>
              ...
              <div className="home-container47">
                ...
                <h1 className="home-text70 textXL">Launch time</h1>
            ...
            <div className="home-contact">
              ...
              <h2 className="home-text72">Type in the bellow form</h2>
              ...
              <div className="home-form">
                ...
                <span className="home-text75 textXL">
                  Complete this form and we will get back to you in 24 hours.
                </span>
                <span className="home-text76 textXS">FULL NAME</span>
                <input
                  type="text"
                  placeholder="Full Name"
                  className="home-textinput textSM input"
                />
                <span className="home-text77 textXS">EMAIL</span>
                <input
                  type="text"
                  placeholder="Email"
                  className="home-textinput1 textSM input"
                />
                <span className="home-text78 textXS">MESSAGE</span>
                <textarea
                  cols="80"
                  rows="4"
                  disabled="true"
