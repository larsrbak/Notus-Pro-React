      ...
      <div className="home-container">
        ...
        <div className="home-section3">
          <div className="home-container18">
            <h6 className="home-text56 textSM">
              <span>ON THE COASTLINE</span>
            </h6>
            <h3 className="home-text58 healine">We are missing the summer</h3>
            ...
            <div className="home-contact">
              ...
              <h2 className="home-text61">Type in the bellow form</h2>
              ...
              <div className="home-form">
                <h1 className="home-text63">Interesseret i en træning?</h1>
                <span className="home-text64 textXL">
                  Complete this form and we will get back to you in 24 hours.
                </span>
                <span className="home-text65 textXS">FULL NAME</span>
                <input
                  type="text"
                  placeholder="Full Name"
                  className="home-textinput textSM input"
                />
                <span className="home-text66 textXS">EMAIL</span>
                <input
                  type="text"
                  placeholder="Email"
                  className="home-textinput1 textSM input"
                />
                <span className="home-text67 textXS">MESSAGE</span>
                <textarea
                  cols="80"
                  rows="4"
                  disabled="true"
